...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { //inicia metodo onCreates
     ...
     //integracion de XML java
        ...
        btnAudioVideo.setOnClickListener(new View.OnClickListener() {
            @Override    public void onClick(View view) {
                Intent abrirVentanaAudioVideo = new Intent(view.getContext(),AudioVideo.class);
                startActivityForResult(abrirVentanaAudioVideo,0);    }
        });
    } // Termona metodo OnCreates
    //para alta de producto
